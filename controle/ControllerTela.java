...
public class ControllerTela {
  ...
  public void criarCamadas(){
    ...
    // RECEPTOR:
    AplicacaoReceptora aplicacao_Receptora = new AplicacaoReceptora(imagemImpressora, botaoEnviar, 
    textoDecodificado, campoDeTexto, botaoVer, sliderErro, textoErros);
    ...
    new CamadaEnlaceDadosReceptora(camada_Aplicacao_Receptora, tipoDeEnquadramento);
    ...
    new CamadaEnlaceDadosTransmissora(camada_Fisica_Transmissora, tipoDeEnquadramento);
